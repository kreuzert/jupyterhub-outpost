...
logger_name = os.environ.get("LOGGER_NAME", "Outpost")
c.JupyterHubOutpost.log_format = f"%(color)s[%(levelname)1.1s %(asctime)s.%(msecs).03d {logger_name} %(name)s %(module)s:%(lineno)d]%(end_color)s %(message)s"
